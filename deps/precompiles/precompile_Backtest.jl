...
function _precompile_()
    ...
    isdefined(Backtest, Symbol("#_fetch_one_pair##kw")) && precompile(Tuple{Backtest.Exchanges.var"#_fetch_one_pair##kw", NamedTuple{(:from, :to), Tuple{String, String}}, typeof(Backtest.Exchanges._fetch_one_pair), PyCall.PyObject, Backtest.Data.ZarrInstance, String, String})
    isdefined(Backtest, Symbol("#_fetch_with_delay##kw")) && precompile(Tuple{Backtest.Exchanges.var"#_fetch_with_delay##kw", NamedTuple{(:df,), Tuple{Bool}}, typeof(Backtest.Exchanges._fetch_with_delay), PyCall.PyObject, String, String})
    ...
    isdefined(Backtest, Symbol("#fetch_pairs##kw")) && precompile(Tuple{Backtest.Exchanges.var"#fetch_pairs##kw", NamedTuple{(:update,), Tuple{Bool}}, typeof(Backtest.Exchanges.fetch_pairs), String, Array{String, 1}})
    isdefined(Backtest, Symbol("#fill_missing_rows!##kw")) && precompile(Tuple{Backtest.Data.var"#fill_missing_rows!##kw", NamedTuple{(:strategy,), Tuple{Symbol}}, typeof(Backtest.Data.fill_missing_rows!), DataFrames.DataFrame, Dates.Day})
    ...
    precompile(Tuple{typeof(Backtest.Data.is_last_complete_candle), String, String})
    precompile(Tuple{typeof(Backtest.Exchanges.__init__)})
    precompile(Tuple{typeof(Backtest.Exchanges.fetch_pairs), String, String})
    precompile(Tuple{typeof(Backtest.Exchanges.loadmarkets!), PyCall.PyObject})
    precompile(Tuple{typeof(Backtest.Exchanges.setexchange!), Symbol})
    precompile(Tuple{typeof(Backtest.Exchanges.to_df), Array{Float64, 2}})
    precompile(Tuple{typeof(Backtest.Misc.Pbar.__init__)})
    precompile(Tuple{typeof(Backtest.Misc.tfnum), Dates.Day})
